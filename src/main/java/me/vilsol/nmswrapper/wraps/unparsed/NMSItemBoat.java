...
public class NMSItemBoat extends NMSItem {
     ...
     * @see net.minecraft.server.v1_8_R3.ItemBoat#a(net.minecraft.server.v1_8_R3.ItemStack, net.minecraft.server.v1_8_R3.World, net.minecraft.server.v1_8_R3.EntityHuman)
     */
