...
public class NMSBlockLightStone extends NMSBlock {
     ...
     * @see net.minecraft.server.v1_9_R1.BlockLightStone#a(java.util.Random)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.BlockLightStone#g(net.minecraft.server.v1_9_R1.IBlockData)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockLightStone#getDropCount(int, java.util.Random)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockLightStone#getDropType(net.minecraft.server.v1_9_R1.IBlockData, java.util.Random, int)
     */
