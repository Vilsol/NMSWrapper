...
public class NMSBlockDoubleStoneStepAbstract extends NMSBlockStepAbstract {
     ...
     * @see net.minecraft.server.v1_9_R1.BlockDoubleStoneStepAbstract#a(net.minecraft.server.v1_9_R1.ItemStack)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.BlockDoubleStoneStepAbstract#b(int)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockDoubleStoneStepAbstract#fromLegacyData(int)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.BlockDoubleStoneStepAbstract#g(net.minecraft.server.v1_9_R1.IBlockData)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockDoubleStoneStepAbstract#getDropData(net.minecraft.server.v1_9_R1.IBlockData)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockDoubleStoneStepAbstract#getDropType(net.minecraft.server.v1_9_R1.IBlockData, java.util.Random, int)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockDoubleStoneStepAbstract#getName()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockDoubleStoneStepAbstract#getStateList()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockDoubleStoneStepAbstract#toLegacyData(net.minecraft.server.v1_9_R1.IBlockData)
     */
