...
public class NMSItemEgg extends NMSItem {
     ...
     * @see net.minecraft.server.v1_9_R1.ItemEgg#a(net.minecraft.server.v1_9_R1.ItemStack, net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.EntityHuman)
     */
