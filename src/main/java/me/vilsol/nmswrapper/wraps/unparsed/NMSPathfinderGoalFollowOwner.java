...
public class NMSPathfinderGoalFollowOwner extends NMSPathfinderGoal {
     ...
     * @see net.minecraft.server.v1_8_R3.PathfinderGoalFollowOwner#a()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.PathfinderGoalFollowOwner#b()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.PathfinderGoalFollowOwner#c()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.PathfinderGoalFollowOwner#d()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.PathfinderGoalFollowOwner#e()
     */
