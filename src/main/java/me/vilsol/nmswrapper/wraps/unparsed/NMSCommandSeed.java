...
public class NMSCommandSeed extends NMSCommandAbstract {
     ...
     * @see net.minecraft.server.v1_9_R1.CommandSeed#a()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.CommandSeed#canUse(net.minecraft.server.v1_9_R1.ICommandListener)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.CommandSeed#getCommand()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.CommandSeed#getUsage(net.minecraft.server.v1_9_R1.ICommandListener)
     */
