...
public class NMSCommandEntityData extends NMSCommandAbstract {
     ...
     * @see net.minecraft.server.v1_9_R1.CommandEntityData#a()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.CommandEntityData#getCommand()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.CommandEntityData#getUsage(net.minecraft.server.v1_9_R1.ICommandListener)
     */
