...
public class NMSWorldGenJungleTree extends NMSWorldGenMegaTreeAbstract {
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.WorldGenJungleTree#generate(net.minecraft.server.v1_9_R1.World, java.util.Random, net.minecraft.server.v1_9_R1.BlockPosition)
     */
