...
public class NMSEnchantmentWaterWorker extends NMSEnchantment {
     ...
     * @see net.minecraft.server.v1_8_R3.EnchantmentWaterWorker#a(int)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.EnchantmentWaterWorker#b(int)
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.EnchantmentWaterWorker#getMaxLevel()
     */
