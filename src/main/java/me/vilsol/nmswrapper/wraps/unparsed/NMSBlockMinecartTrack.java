...
@ReflectiveClass(name = "BlockMinecartTrack")
public class NMSBlockMinecartTrack extends NMSBlockMinecartTrackAbstract {

    public NMSBlockMinecartTrack(Object nmsObject){
        super(nmsObject);
    }
