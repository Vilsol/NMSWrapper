...
public class NMSPathfinderGoalArrowAttack extends NMSPathfinderGoal {
     ...
     * @see net.minecraft.server.v1_9_R1.PathfinderGoalArrowAttack#a()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.PathfinderGoalArrowAttack#b()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.PathfinderGoalArrowAttack#d()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.PathfinderGoalArrowAttack#e()
     */
