...
public class NMSBlockPowered extends NMSBlock {
     ...
     * @see net.minecraft.server.v1_8_R3.BlockPowered#a(net.minecraft.server.v1_8_R3.IBlockAccess, net.minecraft.server.v1_8_R3.BlockPosition, net.minecraft.server.v1_8_R3.IBlockData, net.minecraft.server.v1_8_R3.EnumDirection)
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.BlockPowered#isPowerSource()
     */
