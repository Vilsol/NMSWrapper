...
public class NMSCommandPardon extends NMSCommandAbstract {
     ...
     * @see net.minecraft.server.v1_9_R1.CommandPardon#a()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.CommandPardon#canUse(net.minecraft.server.v1_9_R1.ICommandListener)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.CommandPardon#getCommand()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.CommandPardon#getUsage(net.minecraft.server.v1_9_R1.ICommandListener)
     */
