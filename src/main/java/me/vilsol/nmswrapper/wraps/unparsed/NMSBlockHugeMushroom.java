...
@ReflectiveClass(name = "BlockHugeMushroom")
public class NMSBlockHugeMushroom extends NMSBlock {

    public NMSBlockHugeMushroom(Object nmsObject){
        super(nmsObject);
    }

    public NMSBlockHugeMushroom(NMSMaterial material, NMSMaterialMapColor materialMapColor, NMSBlock block){
        super("BlockHugeMushroom", new Object[]{NMSMaterial.class, NMSMaterialMapColor.class, NMSBlock.class}, new Object[]{material, materialMapColor, block});
    }
