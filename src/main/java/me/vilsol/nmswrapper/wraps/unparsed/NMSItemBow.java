...
public class NMSItemBow extends NMSItem {
     ...
     * @see net.minecraft.server.v1_8_R3.ItemBow#a(net.minecraft.server.v1_8_R3.ItemStack, net.minecraft.server.v1_8_R3.World, net.minecraft.server.v1_8_R3.EntityHuman)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.ItemBow#b()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.ItemBow#d(net.minecraft.server.v1_8_R3.ItemStack)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.ItemBow#e(net.minecraft.server.v1_8_R3.ItemStack)
     */
