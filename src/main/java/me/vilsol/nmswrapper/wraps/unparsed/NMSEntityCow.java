...
@ReflectiveClass(name = "EntityCow")
public class NMSEntityCow extends NMSEntityAnimal {

    public NMSEntityCow(Object nmsObject){
        super(nmsObject);
    }

    public NMSEntityCow(String nmsName, Object[] paramTypes, Object[] params) {
        super(nmsName, paramTypes, params);
    }

    public NMSEntityCow(NMSWorld world){
        super("EntityCow", new Object[]{NMSWorld.class}, new Object[]{world});
    }
