...
public class NMSBlockBed extends NMSBlockDirectional {
     ...
     * @see net.minecraft.server.v1_9_R1.BlockBed#a(net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.BlockPosition, net.minecraft.server.v1_9_R1.IBlockData, net.minecraft.server.v1_9_R1.EntityHuman)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.BlockBed#d()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockBed#doPhysics(net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.BlockPosition, net.minecraft.server.v1_9_R1.IBlockData, net.minecraft.server.v1_9_R1.Block)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockBed#dropNaturally(net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.BlockPosition, net.minecraft.server.v1_9_R1.IBlockData, float, int)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockBed#fromLegacyData(int)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockBed#getDropType(net.minecraft.server.v1_9_R1.IBlockData, java.util.Random, int)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockBed#getStateList()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockBed#interact(net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.BlockPosition, net.minecraft.server.v1_9_R1.IBlockData, net.minecraft.server.v1_9_R1.EntityHuman, net.minecraft.server.v1_9_R1.EnumDirection, float, float, float)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.BlockBed#k()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockBed#toLegacyData(net.minecraft.server.v1_9_R1.IBlockData)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockBed#updateState(net.minecraft.server.v1_9_R1.IBlockData, net.minecraft.server.v1_9_R1.IBlockAccess, net.minecraft.server.v1_9_R1.BlockPosition)
     */
