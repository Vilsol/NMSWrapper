...
public class NMSWorldGenGroundBush extends NMSWorldGenTrees {
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.WorldGenGroundBush#generate(net.minecraft.server.v1_9_R1.World, java.util.Random, net.minecraft.server.v1_9_R1.BlockPosition)
     */
