...
@ReflectiveClass(name = "BlockTrapdoor")
public class NMSBlockTrapdoor extends NMSBlock {

    public NMSBlockTrapdoor(Object nmsObject){
        super(nmsObject);
    }
    ...
    public int a(NMSEnumDirection enumDirection){
        return (int) NMSWrapper.getInstance().exec(nmsObject, enumDirection);
    }
