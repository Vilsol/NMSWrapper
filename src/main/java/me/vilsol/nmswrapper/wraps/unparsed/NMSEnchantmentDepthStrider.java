...
public class NMSEnchantmentDepthStrider extends NMSEnchantment {
     ...
     * @see net.minecraft.server.v1_8_R3.EnchantmentDepthStrider#a(int)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.EnchantmentDepthStrider#b(int)
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.EnchantmentDepthStrider#getMaxLevel()
     */
