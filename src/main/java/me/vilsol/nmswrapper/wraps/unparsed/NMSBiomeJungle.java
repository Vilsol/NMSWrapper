...
public class NMSBiomeJungle extends NMSBiomeBase {
     ...
     * @see net.minecraft.server.v1_8_R3.BiomeJungle#a(net.minecraft.server.v1_8_R3.World, java.util.Random, net.minecraft.server.v1_8_R3.BlockPosition)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.BiomeJungle#b(java.util.Random)
     */
