...
public class NMSPlayerInteractManager extends NMSWrap {
     ...
     * @see net.minecraft.server.v1_9_R1.PlayerInteractManager#a(net.minecraft.server.v1_9_R1.WorldServer)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.PlayerInteractManager#b(net.minecraft.server.v1_9_R1.WorldSettings$EnumGamemode)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.PlayerInteractManager#breakBlock(net.minecraft.server.v1_9_R1.BlockPosition)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.PlayerInteractManager#c()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.PlayerInteractManager#e()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.PlayerInteractManager#getGameMode()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.PlayerInteractManager#interact(net.minecraft.server.v1_9_R1.EntityHuman, net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.ItemStack, net.minecraft.server.v1_9_R1.BlockPosition, net.minecraft.server.v1_9_R1.EnumDirection, float, float, float)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.PlayerInteractManager#isCreative()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.PlayerInteractManager#setGameMode(net.minecraft.server.v1_9_R1.WorldSettings$EnumGamemode)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.PlayerInteractManager#useItem(net.minecraft.server.v1_9_R1.EntityHuman, net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.ItemStack)
     */
