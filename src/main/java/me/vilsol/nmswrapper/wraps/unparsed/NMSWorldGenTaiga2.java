...
public class NMSWorldGenTaiga2 extends NMSWorldGenTreeAbstract {
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.WorldGenTaiga2#generate(net.minecraft.server.v1_8_R3.World, java.util.Random, net.minecraft.server.v1_8_R3.BlockPosition)
     */
