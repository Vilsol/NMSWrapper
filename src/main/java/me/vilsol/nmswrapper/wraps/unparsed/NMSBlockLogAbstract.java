...
public class NMSBlockLogAbstract extends NMSBlockRotatable {
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.BlockLogAbstract#getPlacedState(net.minecraft.server.v1_8_R3.World, net.minecraft.server.v1_8_R3.BlockPosition, net.minecraft.server.v1_8_R3.EnumDirection, float, float, float, int, net.minecraft.server.v1_8_R3.EntityLiving)
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.BlockLogAbstract#remove(net.minecraft.server.v1_8_R3.World, net.minecraft.server.v1_8_R3.BlockPosition, net.minecraft.server.v1_8_R3.IBlockData)
     */
