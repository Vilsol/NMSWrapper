...
public class NMSCommandTell extends NMSCommandAbstract {
     ...
     * @see net.minecraft.server.v1_8_R3.CommandTell#a()
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.CommandTell#getCommand()
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.CommandTell#getUsage(net.minecraft.server.v1_8_R3.ICommandListener)
     */
