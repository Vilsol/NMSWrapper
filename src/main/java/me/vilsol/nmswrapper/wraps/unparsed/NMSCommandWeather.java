...
public class NMSCommandWeather extends NMSCommandAbstract {
     ...
     * @see net.minecraft.server.v1_8_R3.CommandWeather#a()
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.CommandWeather#getCommand()
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.CommandWeather#getUsage(net.minecraft.server.v1_8_R3.ICommandListener)
     */
