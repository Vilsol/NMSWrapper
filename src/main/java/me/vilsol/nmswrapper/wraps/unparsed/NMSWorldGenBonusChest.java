...
public class NMSWorldGenBonusChest extends NMSWorldGenerator {
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.WorldGenBonusChest#generate(net.minecraft.server.v1_8_R3.World, java.util.Random, net.minecraft.server.v1_8_R3.BlockPosition)
     */
