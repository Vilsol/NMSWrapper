...
public class NMSItemExpBottle extends NMSItem {
     ...
     * @see net.minecraft.server.v1_9_R1.ItemExpBottle#a(net.minecraft.server.v1_9_R1.ItemStack, net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.EntityHuman)
     */
