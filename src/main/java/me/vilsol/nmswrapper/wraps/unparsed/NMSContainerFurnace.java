...
public class NMSContainerFurnace extends NMSContainer {
     ...
     * @see net.minecraft.server.v1_8_R3.ContainerFurnace#a(net.minecraft.server.v1_8_R3.EntityHuman)
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.ContainerFurnace#addSlotListener(net.minecraft.server.v1_8_R3.ICrafting)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.ContainerFurnace#b(net.minecraft.server.v1_8_R3.EntityHuman, int)
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.ContainerFurnace#getBukkitView()
     */
