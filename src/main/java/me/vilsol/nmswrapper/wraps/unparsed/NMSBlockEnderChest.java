...
@ReflectiveClass(name = "BlockEnderChest")
public class NMSBlockEnderChest extends NMSBlockContainer {

    public NMSBlockEnderChest(Object nmsObject){
        super(nmsObject);
    }

    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.BlockEnderChest#I()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.BlockEnderChest#a(net.minecraft.server.v1_8_R3.World, int)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.BlockEnderChest#b()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.BlockEnderChest#c()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_8_R3.BlockEnderChest#d()
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.BlockEnderChest#fromLegacyData(int)
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.BlockEnderChest#getDropType(net.minecraft.server.v1_8_R3.IBlockData, java.util.Random, int)
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.BlockEnderChest#getPlacedState(net.minecraft.server.v1_8_R3.World, net.minecraft.server.v1_8_R3.BlockPosition, net.minecraft.server.v1_8_R3.EnumDirection, float, float, float, int, net.minecraft.server.v1_8_R3.EntityLiving)
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.BlockEnderChest#getStateList()
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.BlockEnderChest#interact(net.minecraft.server.v1_8_R3.World, net.minecraft.server.v1_8_R3.BlockPosition, net.minecraft.server.v1_8_R3.IBlockData, net.minecraft.server.v1_8_R3.EntityHuman, net.minecraft.server.v1_8_R3.EnumDirection, float, float, float)
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.BlockEnderChest#postPlace(net.minecraft.server.v1_8_R3.World, net.minecraft.server.v1_8_R3.BlockPosition, net.minecraft.server.v1_8_R3.IBlockData, net.minecraft.server.v1_8_R3.EntityLiving, net.minecraft.server.v1_8_R3.ItemStack)
     */
    ...
    /**
     * @see net.minecraft.server.v1_8_R3.BlockEnderChest#toLegacyData(net.minecraft.server.v1_8_R3.IBlockData)
     */
