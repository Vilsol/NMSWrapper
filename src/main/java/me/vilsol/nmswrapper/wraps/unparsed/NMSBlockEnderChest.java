...
public class NMSBlockEnderChest extends NMSBlockContainer {
     ...
     * @see net.minecraft.server.v1_9_R1.BlockEnderChest#I()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.BlockEnderChest#a(net.minecraft.server.v1_9_R1.World, int)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.BlockEnderChest#b()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.BlockEnderChest#c()
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.BlockEnderChest#d()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockEnderChest#fromLegacyData(int)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockEnderChest#getDropType(net.minecraft.server.v1_9_R1.IBlockData, java.util.Random, int)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockEnderChest#getPlacedState(net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.BlockPosition, net.minecraft.server.v1_9_R1.EnumDirection, float, float, float, int, net.minecraft.server.v1_9_R1.EntityLiving)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockEnderChest#getStateList()
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockEnderChest#interact(net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.BlockPosition, net.minecraft.server.v1_9_R1.IBlockData, net.minecraft.server.v1_9_R1.EntityHuman, net.minecraft.server.v1_9_R1.EnumDirection, float, float, float)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockEnderChest#postPlace(net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.BlockPosition, net.minecraft.server.v1_9_R1.IBlockData, net.minecraft.server.v1_9_R1.EntityLiving, net.minecraft.server.v1_9_R1.ItemStack)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.BlockEnderChest#toLegacyData(net.minecraft.server.v1_9_R1.IBlockData)
     */
