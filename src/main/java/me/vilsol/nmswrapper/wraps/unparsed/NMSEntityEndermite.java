...
@ReflectiveClass(name = "EntityEndermite")
public class NMSEntityEndermite extends NMSEntityMonster {

    public NMSEntityEndermite(Object nmsObject){
        super(nmsObject);
    }

    public NMSEntityEndermite(NMSWorld world){
        super("EntityEndermite", new Object[]{NMSWorld.class}, new Object[]{world});
    }
