...
public class NMSItemMinecart extends NMSItem {
    ...
    public NMSItemMinecart(NMSEnumMinecartType enumMinecartType){
        super("ItemMinecart", new Object[]{NMSEnumMinecartType.class}, new Object[]{enumMinecartType});
    }

    /**
     * @see net.minecraft.server.v1_9_R1.ItemMinecart#interactWith(net.minecraft.server.v1_9_R1.ItemStack, net.minecraft.server.v1_9_R1.EntityHuman, net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.BlockPosition, net.minecraft.server.v1_9_R1.EnumDirection, float, float, float)
     */
