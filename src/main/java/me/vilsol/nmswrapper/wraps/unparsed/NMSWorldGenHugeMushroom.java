...
public class NMSWorldGenHugeMushroom extends NMSWorldGenerator {
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.WorldGenHugeMushroom#generate(net.minecraft.server.v1_9_R1.World, java.util.Random, net.minecraft.server.v1_9_R1.BlockPosition)
     */
