...
public class NMSItemSoup extends NMSItemFood {
     ...
     * @see net.minecraft.server.v1_9_R1.ItemSoup#b(net.minecraft.server.v1_9_R1.ItemStack, net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.EntityHuman)
     */
