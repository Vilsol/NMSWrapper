...
public class NMSItemDye extends NMSItem {
     ...
     * @see net.minecraft.server.v1_9_R1.ItemDye#a(net.minecraft.server.v1_9_R1.ItemStack, net.minecraft.server.v1_9_R1.EntityHuman, net.minecraft.server.v1_9_R1.EntityLiving)
     */
    ...
    /**
     * TODO Find correct name
     * @see net.minecraft.server.v1_9_R1.ItemDye#e_(net.minecraft.server.v1_9_R1.ItemStack)
     */
    ...
    /**
     * @see net.minecraft.server.v1_9_R1.ItemDye#interactWith(net.minecraft.server.v1_9_R1.ItemStack, net.minecraft.server.v1_9_R1.EntityHuman, net.minecraft.server.v1_9_R1.World, net.minecraft.server.v1_9_R1.BlockPosition, net.minecraft.server.v1_9_R1.EnumDirection, float, float, float)
     */
