...
@ReflectiveClass(name = "CommandToggleDownfall")
public class NMSCommandToggleDownfall extends NMSCommandAbstract {

    public NMSCommandToggleDownfall(Object nmsObject){
        super(nmsObject);
    }
